...
- [**.NET** Processing Unit]({%latestneturl%}/processing-units.html) -  has its code components in .NET, and may contain a space component.
...
- A **.NET** Processing Unit is packaged as a directory structure. For more information, please refer to the [XAP.NET Programmer's Guide]({%latestneturl%}/processing-units.html).
