...
|:---------|:--------|:----------------|:---------------|:------------------|
| <nobr>GS-12315</nobr> | Transaction consolidation of transient only transactions causes timeout | 10.1.1| 9640,9417 | All |
| GS-12324 | First row in Spaces view should be selected by default | 10.1.1 |  | Java |
| GS-12327 | In 'Spaces' view, 'types' shows 'Loading data types...' when no space is selected | 10.1.1  | | All |
...
| GS-12353 | Service details of REST PU shows invalid URL on Windows | 10.1.1  |  | Java |
| GS-12356 | RLIKE/LIKE fails (DIV0) when executed against a SpaceIndex property belonging to an abstract parent class | 10.1.1 | 9654 | All |
| GS-12357 | Deployment of a PU containing an abstract bean fails | 10.1.1  |  9680 | All |
| GS-12358 | PU metrics are not reported in XAP.NET | 10.1.1 |  | .NET |
| GS-12360 | spring.schemas files were not updated for version 10.1.0 | 10.1.1 |  | Java |
| GS-12361 | When running with more than one gsm, as result Monitoring view is unavailable | 10.1.1 |  | All |
| GS-12366 | Events grid in new Processing Unit view is always empty | 10.1.1 | | Java |
| GS-12372 | In some grids meter bars displayed as cutted | 10.1.1  | | Java |
| GS-12376 | Handle default selection in Spaces view | 10.1.1 | | Java |
...
| GS-11381 | ESM caught in a re-balancing loop after addition of new machine in rare condition(cpu reported as 0) |   <br>10.1.0 | 8242 | All |
