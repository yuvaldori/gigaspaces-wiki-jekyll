...
please note that pojo properties should implement hashcode and equals so matching can succeed.(avoid using take on notify when one of the object fields is primitive array)
