...
{%endhighlight%}
{%learn%}{%currentjavaurl%}/transaction-management.html{%endlearn%}
...
{%learn%}{%currentjavaurl%}/polling-container.html{%endlearn%}
...
{%learn%}{%currentjavaurl%}/notify-container.html{%endlearn%}
...
{%endhighlight%}
{%learn%}{%currentjavaurl%}/transaction-optimistic-locking.html{%endlearn%}
...
{%endhighlight%}
{%learn%}{%currentjavaurl%}/transaction-pessimistic-locking.html{%endlearn%}
...
{%learn%}{%currentjavaurl%}/transaction-read-modifiers.html{%endlearn%}
