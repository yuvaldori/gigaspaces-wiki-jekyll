...
{% note %} The `ISpaceProxy.WriteMultiple` method can be used to write a batch of documents.{%endnote%}
...
{% info %} Changing FIFO support after a type has been registered is not supported. {%endinfo%}
